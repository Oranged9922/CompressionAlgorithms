...
namespace huffmanTree
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //#region Check parameters and create Reader
            //if (args.Length != 1)
            //{
            ...
            var r = new Reader("oneCharacterOnly.in");
            var tree = Huffman.BuildTree(r);
            r.ResetPointer();
            using(var a = new HuffmanFileWriter("oneCharacterOnly.in" + ".huff"))
            Huffman.EncodeBy(tree, r, a);
        }
    }
}
...
//			{
//				var res = Huffman.BuildTree(new Reader("insOuts/h1/binary.in"));
//				var shouldBe = File.ReadAllText("insOuts/h1/binary.out");
